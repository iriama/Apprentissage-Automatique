...
def predict_main(image_path, model_path, wanted_class, wanted_label=''):
...
print('--- Classifieur Mer vs Ailleurs : TEAM LES PURISTES')
print('>>>> Les images devront etre placees sous le dossier "images"')
img_name = input('nom de l\'image (exemple: "monimage.jpeg") : ')

predict_main('./images/' + img_name, '../models/bayes.joblib', 1, 'Mer')